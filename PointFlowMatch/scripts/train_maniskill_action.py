...
from pfp.policy.fm_policy_maniskill_action import FMPolicy
...
def main():
    ...
    data_path_train = "/home/cfc/桌面/PointFlowMatch/data/peg_demo_train"
    data_path_valid = "/home/cfc/桌面/PointFlowMatch/data/peg_demo_valid"

    seed = 1234
    epochs = 1500
    log_wandb = False
    run_name = "maniskill_train_peg_insertion_action"
