...
def run_episode_with_seed(
    ...
    if save_video:
        if videos_path is not None:
            video_output_dir = str(videos_path)
        else:
            video_output_dir = "outputs/videos/collect_success_demo"
