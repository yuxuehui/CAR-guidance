...
from pfp.data.dataset_maniskill_stack_cube import RobotDatasetManiskillStackCube
...
def main():
    ...
    data_path_train = str(repo_root / "data" / "stack_cube_demo_big_train")
    data_path_valid = str(repo_root / "data" / "stack_cube_demo_big_valid")

    seed = 1234
    epochs = 1500
    log_wandb = False
    run_name = "maniskill_train_stack_cube_concat_goal_pos_big"
    ...
    dataset_train = RobotDatasetManiskillStackCube(**dataset_kwargs)
    ...
    dataset_valid = RobotDatasetManiskillStackCube(**dataset_kwargs)
