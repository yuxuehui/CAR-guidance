...
def test_single_episode(seed=1, ckpt_name="maniskill_train", ckpt_episode="latest", max_steps=200, episode_dir=None, save_video=True, video_output_dir=None, video_resolution=(1920, 1080)):
    ...
    while not done and step_count < max_steps:
        ...
        print(f"  Step {step_count}: 推理得到 {n_pred_steps} 个预测动作，开始执行前8个...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="简单的ManiSkill测试脚本",
        epilog="""
使用示例:
  python scripts/test_simple.py
  python scripts/test_simple.py --ckpt_name maniskill_train --ckpt_episode latest
  python scripts/test_simple.py --episode_dir ./data/demo_data_diverse_small/episode3
        """
    )
    ...
    parser.add_argument("--seed", type=int, default=13, help="测试seed（如果未指定episode_dir时使用，默认: 13）")
    ...
    parser.add_argument("--video_output_dir", type=str, default=None, help="视频保存目录 (默认: outputs/videos/test_simple/)")
